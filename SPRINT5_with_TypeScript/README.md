## Chat application in TypeScript with Google OAuth 2.0 and data persistence in a MySQL database using TypeORM (with ormconfig.js for TypeORM configuration)
