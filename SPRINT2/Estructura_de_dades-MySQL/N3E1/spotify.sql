...
-- Mon 15 Feb 2021 03:46:19 PM CET
...
-- -----------------------------------------------------
-- Table `SPOTIFY`.`following_artists`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `SPOTIFY`.`following_artists` ;

CREATE TABLE IF NOT EXISTS `SPOTIFY`.`following_artists` (
  `user_id` INT NOT NULL,
  `artist_id` INT NOT NULL,
